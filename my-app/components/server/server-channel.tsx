...
const ServerChannel = ({ channel, server, role }: ServerChannelProps) => {
  ...
  return (
    <Button
      variant={"destructive"}
      className={cn(
        "px-2 py-2 rounded-md flex justify-start gap-x-2 w-full bg-transparent hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1"
      )}
      onClick={onClick}
    >
      ...
      <p
        className={cn(
          params.channelId === channel.id && "text-purple-700",
